...
ggsave(here("Graphs", "2021-02-23", "Employ_by_indus.pdf"),
...
emp_total_comp%>%
  ...
  theme(legend.position = "none",
        ...
        plot.background = element_rect(fill = "#CCFFCC"),
        plot.title = element_text(size=14, face= "bold", colour= "black" ))
ggsave(here("Graphs", "2021-02-23", "Pct_diff_emp.pdf"),
       width = 9, height = 5.5, device = cairo_pdf)
```
...
lh%>%
  ...
  theme(legend.position = "none",
        ...
        plot.background = element_rect(fill = "#CCFFCC"),
        plot.title = element_text(size=14, face= "bold", colour= "black" ))
ggsave(here("Graphs", "2021-02-23", "Pct_chg_maj.pdf"),
       width = 9, height = 5.5, device = cairo_pdf)
...
earning_total%>%
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        plot.title = element_text(size=14, face= "bold", colour= "black" ))
ggsave(here("Graphs", "2021-02-23", "wage_sex_race.pdf"),
       width = 9, height = 5.5, device = cairo_pdf)
```
```{r wage 2019 vs. 2020}
earning_comp <- earn%>%
...
earning_comp%>%
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        plot.background = element_rect(fill = "#CCFFCC"),
        plot.title = element_text(size=14, face= "bold", colour= "black" ))
ggsave(here("Graphs", "2021-02-23", "growth_wage.pdf"),
       width = 9, height = 5.5, device = cairo_pdf)
```
